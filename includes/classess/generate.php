...
class generate extends FPDF_rotation
{
    ...
    function generate($size='A4',$currency='€',$language='en')
    {
        $this->columns = 5;
        $this->items = array();
        $this->totals = array();
    ...
    function email($to,$from,$subject,$message,$sendToMe,$nameVal){
        ...
        $body .= $message.$eol;
        $body .= '</p>';
        $body .= '<p style="margin-top:20px;clear:both;font-size:10px;"><strong>Invoice Generator</strong> - Invoice generator application by <a href="#" target="_blank">Invoice Generator</a></p>';
        $body .= $eol;

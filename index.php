...
<head lang="en">
    ...
    <title>Invoice Generator - PDF Invoices Generator App by Invoice Generator</title>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <h1>
                Invoice Generator
                <small>PDF Invoices Generator App by <a href="#">Invoice Generator</a></small>
            </h1>
            <a class="logo" href="#"><img src="images/logo.png" alt="Invoice Generator Logo"/></a>
        </div>
    </header>
    ...
    <footer>
        <div class="container">
            <p class="pull-left">&copy 2019. All rights are reserved to the developers.</p>
            <p class="pull-right">Developed by <a href="#" target="_blank">Invoice Generator</a></p>
        </div>
    </footer>
